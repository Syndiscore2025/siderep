...
export function buildRenewalGenerationPrompt(context: RenewalMerchantContext): string {
  ...
  return [
    ...
    '- Closing CTA: one short sentence asking the merchant to send over 3-4 months of business bank statements so you can see what is available. Do not ask for a call, meeting, or phone time unless userNotes explicitly asks for one.',
