...
export function buildRenewalGenerationPrompt(context: RenewalMerchantContext): string {
  ...
  return [
    ...
    '- SMS: write it separately, not as a mechanical email summary. Plain text only—no Markdown, bold, bullets, or line lists—at roughly 60-130 words. Open with the same time-of-day greeting and first name, make it conversational, work 1-2 of the same specific capital uses into a sentence, state the funding situation, and close by politely asking them to please send 3-4 months of business bank statements or a quick reply rather than a call, with a brief thank you. Do not append a signature, representative name, company, phone, or email at the end.',
    '',
