...
export function buildRenewalGenerationPrompt(context: RenewalMerchantContext): string {
  ...
  return [
    ...
    '- Closing CTA: one short sentence asking the merchant to send over 3-4 months of business bank statements so you can see what is available. Do not ask for a call, meeting, or phone time unless userNotes explicitly asks for one. The bank-statement CTA is the final line of the email.',
    ...
    '- SMS: write it separately, not as a mechanical email summary. Plain text only—no Markdown, bold, bullets, or line lists—at roughly 60-130 words. Make it conversational, work 1-2 of the same specific capital uses into a sentence, state the funding situation, and close by asking for 3-4 months of business bank statements or a quick reply rather than a call. Do not append a signature, representative name, company, phone, or email at the end.',
    '',
